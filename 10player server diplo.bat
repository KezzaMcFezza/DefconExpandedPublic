...
start "Game Log Processor 10 Player Server" cmd /k python game_log_processor10player.py "game_events_10playerdiplo.log" "game_logs"
...
Dedcon10p.exe 10playerdiplo.txt 
