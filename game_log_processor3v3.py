...
def create_new_game_data():
    return {
        ...
        'end_time': None,
        'duration': None,
        'gameType': 'DefconExpanded | 3v3 | Totally Random'
    }

def process_game_logs(game_events_file, output_directory):
    print(f"Starting game log processor for 3v3 random server")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python game_log_processor3v3.py <game_events_file> <output_directory>")
        sys.exit(1)
